...
async def expert_worker_step(
    ...
    try:
        ...
        try:
            ...
            direct_web_result = pop_web_search_result(ctx.deps, web_scope)
        ...
        sources = source_references_for_result(
            domain, result, web_result=direct_web_result
        )
        logfire.info(
            "Expert run finished",
            **trace_attrs,
        ...
        return AgentArtifact(
            ...
            sources=source_references_for_result(
                domain, None, web_result=direct_web_result
            ),
        )
