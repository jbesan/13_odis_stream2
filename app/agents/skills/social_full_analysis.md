...
2. Identifie les structures locales proposant des cours de français (FLE, alphabétisation) via `search_places_batch_tool` avec grande parcimonie (maximum 3 à 5 requêtes ciblées dans un seul appel batch).
