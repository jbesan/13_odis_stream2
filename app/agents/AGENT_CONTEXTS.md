...
| `agent_housing_expert` | Housing Expert | [housing_expert.py](file:///Users/jacques/dev/13_odis_stream2/app/agents/housing_expert.py) | Rent m², housing Delay, J'Accueille hosts | `search_places_batch_tool`, `compute_routes_tool`<br>• `WebSearchTool` (Google Search) |
