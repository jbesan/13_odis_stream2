...
async def test_golden_scenarios_evaluation():
    ...
    for scenario in scenarios:
        ...
        async def run_graph_task(inputs: str) -> str:
            ...
            city_res = state.search_results.get_by_code(scenario["search_results"]["results"][0]["codgeo"])
            ...
            assert state.usage.total_tokens > 0, "No token usage was recorded in the state"
        ...
        assert assertion_result.value is True, f"LLMJudge failed. Reason: {assertion_result.reason}"
