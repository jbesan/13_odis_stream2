...
async def test_refiner_agent_live_shortlisted_city():
    ...
    rec1 = CommuneResult(
        codgeo="44055", name="Nantes", population=300000, global_score=0.92
    )
    rec1.scores = {}

    pressentie = CommuneResult(
        codgeo="72181", name="Le Mans", population=140000, global_score=0.85
    )
    pressentie.scores = {}
    ...
    state.search_results = SearchResultsData(
        ...
        current_geo=CommuneResult(
            codgeo="75056", name="Paris", population=2100000, global_score=0.4
        ),
