...
def test_compute_sante_scores_direct(base_sample_data, live_scores_cat):
    ...
    assert 'sante_structures_scaled' not in res_none.columns or res_none['sante_structures_scaled'].isna().all() or (res_none['sante_structures_scaled'] == 0.0).all()
