...
def test_live_jobs_scoring_aicha_scenario():
        ...
        [
            {
                ...
                "name": "Marseille Services",
            },
            {
                "codgeo": "13001",
                "key": {"lecture-ecriture-calcul--maitriser-le-francais"},
                "name": "Aix Services",
            },
        ]
    ).set_index("codgeo")
    ...
    scores_cat = pd.DataFrame(
        [
            {
                "score": "met_match_adult1_scaled",
                "min_bound": 0,
                "max_bound": 20,
                "cat": "emploi",
                "weight": 1.0,
                "metric": "met_match_adult1",
            },
            {
                "score": "inc_services_incl_scaled",
                "min_bound": 0,
                "max_bound": 1,
                "cat": "inclusion",
                "weight": 1.0,
                "metric": "inc_services_incl_scaled",
            },
            {
                "score": "edu_maternelle_scaled",
                "min_bound": 0,
                "max_bound": 5,
                "cat": "education",
                "weight": 1.0,
                "metric": "edu_maternelle_ct",
            },
            {
                "score": "edu_college_scaled",
                "min_bound": 0,
                "max_bound": 5,
                "cat": "education",
                "weight": 1.0,
                "metric": "edu_college_ct",
            },
        ]
    )
    ...
    config.inc_services_selection = [
        CriteriaItem(code=s, label=s) for s in DEFAULT_INC_SERVICES_CORE
    ]
