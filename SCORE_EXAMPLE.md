...
*   **Health**: Maternité
*   **Inclusion**:
    *   **Socle Administratif**: Default list (CAF, CPAM, etc.) - *Implicitly selected*
...
2.  Commune scores are aggregated to the **Bassin de Vie** level using a population-weighted average.
    *   *Example*: If a BV has Commune A (Pop 1000, Score 0.8) and Commune B (Pop 500, Score 0.4):
...
6.  **Mobilité**: ~15km from Marseille, same EPCI -> Score **0.85**

$$
\text{Score} = \frac{100(0.9) + 100(0.6) + 100(1.0) + 100(1.0) + 50(0.8) + 50(0.85)}{500}
$$
$$
\text{Score} = \frac{90 + 60 + 100 + 100 + 40 + 42.5}{500} = \frac{432.5}{500} = \mathbf{0.865}
$$
