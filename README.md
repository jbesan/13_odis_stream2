...
- **Expertise Emploi (France Travail Live) :** Intégration en temps réel des offres d'emploi via l'API France Travail (Search API V2). Le moteur traduit automatiquement les profils métiers (FAP) en codes ROME pour un scoring "Live" ultra-précis tenant compte de la tension de recrutement et du volume réel d'offres par commune.
